    ...
    create table CondicionDeSalud (
        ...
        condicionDeSaludId bigint generated by default as identity (start with 1),
        primary key (condicionDeSaludId)
    )

    create table Condimentacion (
        condimentacionId bigint generated by default as identity (start with 1),
    ...
    create table Consulta (
        recetaId bigint generated by default as identity (start with 1),
    ...
    create table Consulta_Receta (
        Consulta_recetaId bigint not null,
    ...
    create table Filtro (
        DTYPE varchar(31) not null,
        filtroId bigint generated by default as identity (start with 1),
        criterio longvarbinary,
    ...
    create table Grupo (
        grupoId bigint generated by default as identity (start with 1),
        primary key (grupoId)
    )
    ...
    create table Ingrediente (
        ingredienteID bigint generated by default as identity (start with 1),
        nombre varchar(255),
    ...
    create table ObservadorConsultas (
        DTYPE varchar(31) not null,
        observadorID bigint generated by default as identity (start with 1),
    ...
    create table ProcesoAsincronico (
        DTYPE varchar(31) not null,
        ProcesoAsincronicoId bigint generated by default as identity (start with 1),
    ...
    create table Receta (
        recetaId bigint generated by default as identity (start with 1),
        cantCalorias double not null,
        cantCaloriasTotales double not null,
        dificultad integer,
        nombre varchar(255),
    ...
    create table Usuario (
        usuarioId bigint generated by default as identity (start with 1),
        aceptado boolean,
    ...
    alter table Consulta_Receta 
        add constraint FK_ra0s4pmpvt7ro3ure3d5bkds8 
        foreign key (Consulta_recetaId) 
        references Consulta
    ...
    alter table HistorialConsultaUsuario_Receta 
        ...
        references HistorialConsultaUsuario
    ...
    alter table ObservadorConsultas_HistorialConsultaUsuario 
        ...
        references ObservadorConsultas
