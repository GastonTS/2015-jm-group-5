...
public class StFiltroTest {
	...
	public void excesoDeCaloriasDevuelveLasQueTenganMenosDe500() {
		...
		assertEquals(
				todasLasRecetas
						.stream()
						.filter(unaReceta -> excesoDeCalorias.filtrar(
								unaReceta, usuarioMock))
	...
	public void segunCondicionesDeUsuarioDevuelveSoloLasAdecuadas() {
		...
		assertEquals(
				todasLasRecetas
						.stream()
						.filter(unaReceta -> segunCondicionesDelusuario
								.filtrar(unaReceta, usuarioMock))
	...
	public void leGustaAlUsuarioSoloDevuelveLasQueLeGustan() {
		...
		assertEquals(
				todasLasRecetas
						.stream()
						.filter(unaReceta -> leGustaAlUsuario.filtrar(
								unaReceta, usuarioMock))
	...
	public void siEsCaraSuPreparacionNoLaDevuelve() {
		...
		assertEquals(
				todasLasRecetas
						.stream()
						.filter(unaReceta -> preparacionBarata.filtrar(
								unaReceta, usuarioMock))
